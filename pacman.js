...
function collide({ cir, recta }) {
  //Pacman will stop when colliding with any of the boundaries but since he will not actually hit it, the code will be flase and we will be able to move it
  return (
